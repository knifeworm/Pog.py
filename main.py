...
app = Quart(__name__)
ipc_client = ipc.Client(secret_key = "fgamer")

app.config["SECRET_KEY"] = "test123"
app.config["DISCORD_CLIENT_ID"] = 817736932435165184   # Discord client ID.
app.config["DISCORD_CLIENT_SECRET"] = "ON4R96HJ1hUAVeaupKJffbIQREbe5spf"   # Discord client secret.
